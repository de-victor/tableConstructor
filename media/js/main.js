...
app.tableController = (()=>{
    ...
    let loadScope = ()=>{
        let elements = {btnBuildTables : $('.btn-build'),
                        tableTeste  : $('.tabela-teste'),
    ...
    let buildTableTeste = ()=>{
        ...
        let tabela = {header : [{head : 'Funcionaro ground', 
                      ...
                      buttons : [{element : '<input type="button" value="remover" class="btn btn-primary button1"></input>', 
                                  function : acaoRemover, 
                                  style : 'width : 1%'},
                                 {element : '<input type="button" value="alterar" class="btn btn-primary button2"></input>', 
